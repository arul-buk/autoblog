...
export async function imageStep(state, config, options) {
  ...
  try {
    ...
    if (options.costTracker && imagePath) {
      options.costTracker.addImage('image', { promptTokenCount: 200, candidatesTokenCount: 0 }, config.models?.image || 'gemini-3.1-flash-image-preview', 1);
    }
