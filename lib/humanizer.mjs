 ...
 */
export async function humanizePost(apiKey, config, content) {
  ...
  console.log('  Humanizing blog post (removing AI patterns)...');

  const systemInstruction = buildHumanizationPrompt();
