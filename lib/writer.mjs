...
/**
 * Build style guide block for the writer prompt.
 */
function buildStyleGuideBlock(styleGuide) {
 ...
 */
function buildWriterPrompt({ topic, slug, author, today, relatedPosts, config, keywordData, writerNotes, styleGuide }) {
